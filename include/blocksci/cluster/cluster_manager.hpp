...
namespace blocksci {
    ...
    public:
        ...
        static ClusterManager createClustering(blocksci::ClusterManager &clusterManager, BlockRange &chain, const heuristics::ChangeHeuristic &heuristic, const std::string &outputPath, bool overwrite = false, bool ignoreCoinJoin = false);
        static ClusterManager createClustering(blocksci::ClusterManager &clusterManager, BlockRange &chain, const std::function<ranges::any_view<Output>(blocksci::ClusterManager &clusterManager, const Transaction &tx)> &changeHeuristic, const std::string &outputPath, bool overwrite, bool ignoreCoinJoin);
